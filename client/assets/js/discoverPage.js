...
/*
console.log(datas,"before click");
$('#btnMedical').click(async ()=>{
    datas="Sports";
    alert(datas);
  
 
});
$('#btnHealth').click(async ()=>{
  datas="Healthcare";
  alert(datas);


});
console.log(datas,"After Click");
*/
...
$('#notForSale').click(async ()=>{
  ...
  recentlyMintedAndNotOnSale(datas);
});
...
$('#Self').click(()=>{
  ...
  datas="SelfFinancialEnhancement";
  loader();
  viewAll(datas);
});
