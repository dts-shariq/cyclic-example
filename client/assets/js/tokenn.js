    ...
    for (i = 0; i < activeArtwork.length; i++) {
      if(activeArtwork[i].active == true){
        ...
        if(tokenAddress.toLowerCase() + id.toLowerCase() == token.toLowerCase()){
          ...
          console.log("data for the");
          console.log(picReader.length);
      
          for (let i = 0; i < picReader.length; i++) {
            ...
            if(i==0){
              ...
              li.classList.add('list-inline-item', 'active');
              a.setAttribute('id', 'carousel-selector-0');
              a.setAttribute('data-slide-to', '0');
              a.innerHTML = `<img class="img-fluid" id='picReaders`+tokenAddress+id+`' src="${picReader[i]}" alt="">`;
              div.innerHTML = `<img class="d-block w-100" id='picReader`+tokenAddress+id+`' src="${picReader[i]}" alt="">`;
              li.appendChild(a);
              imgdiv.appendChild(div);
              btnImage.appendChild(li);
             }
             else{
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div id="custCarousel" class="carousel slide" data-ride="carousel" align="center">
        ...
        <div class="carousel-inner" id= "imgHead">
        ...
        <!-- Thumbnails -->
        <ol class="carousel-indicators list-inline" id="btnImage">
