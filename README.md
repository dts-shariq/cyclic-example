...
Make sure you are running on a local server, by going into the root folder and running `python3 -m http.server` in the command line and then viewing the site via `192.168.100.161.sslip.io:8080/client`
